...
===========================================================================
*/
// this file is the asset-side mirror of codemp/ui/menudef.h, kept in sync with it.
// it is parsed at runtime by botlib's text preprocessor (used for .menu scripting) via
// trap->PC_LoadGlobalDefines("ui/jamp/menudef.h") -- without this asset copy, the mod's
// own .menu files fall back to base JKA's stock definitions, which lack every constant
// added since (e.g. ITEM_TYPE_INTSLIDER). include guards aren't necessary.
