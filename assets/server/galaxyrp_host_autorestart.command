...
# galaxyrp_host_autorestart.command -- macOS dedicated server launcher with auto-restart
#
# Same as galaxyrp_host.command, but if the server dies it is brought straight back up. A clean
